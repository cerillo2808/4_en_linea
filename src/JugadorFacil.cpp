...
int JugadorFacil::jugar(Tablero tablero) {
  ...
  // se crea una distribución uniforme en el rango que va desde la posicion cero
  // al número de columnas disponibles
  uniform_int_distribution<int> distribution(
      0, tablero.getColumnasDisponibles().size() - 1);
  // se retorna la columna disponible según la posición aleatoria obtenida
