...
ConfNuevoJuego::ConfNuevoJuego(const wxString& title): wxFrame(nullptr, wxID_ANY, title, wxDefaultPosition, wxSize(500, 400))
{
    ...
    wxStaticText* staticText= new wxStaticText(panelPrincipal,wxID_ANY,"Configuraciones del nuevo juego", wxDefaultPosition);
    ...
    wxRadioBox* radioBox1= new wxRadioBox(panelPrincipal,wxID_ANY, "Seleccione el Jugador 1 : ",wxDefaultPosition,wxDefaultSize,choices);
    wxRadioBox* radioBox2= new wxRadioBox(panelPrincipal,wxID_ANY, "Seleccione el Jugador 2 : ",wxDefaultPosition,wxDefaultSize,choices);

    radioBox1->SetFont(fuenteR);
    radioBox2->SetFont(fuenteR);


    wxStaticText* textoSpin= new wxStaticText(panelPrincipal,wxID_ANY,"Seleccione las dimenciones del tablero", wxDefaultPosition);
    textoSpin->SetFont(fuenteT);
    wxStaticText* textoSpin2= new wxStaticText(panelPrincipal,wxID_ANY,"Casillas Horizontales: ", wxPoint(120,150));
    textoSpin2->SetFont(fuenteR);
    wxSpinCtrl* spinCtrl = new wxSpinCtrl(panelPrincipal, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 4, 15, 7);
    spinCtrl->SetFont(fuenteR);
    wxStaticText* textoSpin3= new wxStaticText(panelPrincipal,wxID_ANY,"Casillas Verticales: ", wxDefaultPosition);
    textoSpin3->SetFont(fuenteR);
    wxSpinCtrl* spinCtrl2 = new wxSpinCtrl(panelPrincipal, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 4, 15, 7);
    spinCtrl2->SetFont(fuenteR);
    wxButton* botonIniciarJuego=new wxButton(panelPrincipal, wxID_ANY,"INICIAR",wxDefaultPosition, wxSize(400, 100));
    wxButton* botonRegresar=new wxButton(panelPrincipal, wxID_ANY,"Regresar",wxDefaultPosition, wxSize(400, 100));
...
void ConfNuevoJuego::jugadorUno(wxCommandEvent& event){
    ...
    if(radioBox1){
        //como sabemos que sí es un puntero no nulo a un wxRadioBox podemos usar métodos de este
...
void ConfNuevoJuego::botonRegresar(wxCommandEvent& event){
    Close(true);
